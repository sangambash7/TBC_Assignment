    ...
    const updateProduct = () => {
        ...
        const updatedProducts = productList.map((product) =>
            product.id === editProduct.id
                ? { ...product, title: editProduct.title, description: editProduct.description, price: parseFloat(editProduct.price), image: editProduct.image }
                : product
        );
                ...
                {filteredProductList.map((product) => (
                    <div key={product.id}>
                        <Product
                            ...
                            image={product.thumbnail || product.image || "fallback-image-url.jpg"}
                            price={product.price}
                        />
